...
# Manages config settings using config.txt
configs = {}
...
def run_experiment(controls):
    ...
    cmds = ['sysctl net.ipv4.tcp_congestion_control=' + controls['A'],
            'sysctl net.ipv4.tcp_congestion_control=' + controls['B'],
            'sysctl net.ipv4.tcp_congestion_control=' + controls['C'],
            'sysctl net.ipv4.tcp_congestion_control=' + controls['D']]
